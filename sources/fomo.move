module fomo::fomo {
    ...
    public struct Bus has key {
        ...
        reward_rate: u64,
        last_reset: u64,
        rewards: balance::Balance<FOMO>,
        epoch_hashes: u64,
    }

    public struct FOMO has drop {}
    ...
    fun init(witness: FOMO, ctx: &mut TxContext) {
        let (mut treasury_cap, metadata) = coin::create_currency(
            witness, DECIMALS, b"FOMO", b"FOMO", b"Algorithmic Proof-of-Work MEME.",
            option::some(fomo::icon::get_icon_url()), ctx
        );
        ...
        let treasury_vesting_start_time_sec = 1727883900;
